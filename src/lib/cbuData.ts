...
//
// GENERATED from "Copy of UK CSO - LoadStar-PS Sizing Calculator V3.6.xlsm"
// by automation/cbu_data_gen.py -- do not hand-edit. Rerun the script against the
// new workbook when the calculator is revised, and diff the output: the sheet has
// three rival tables ('Tables', 'Pricing Analysis for CSO', 'Table 1') that are
// maintained separately and do not always agree. Quantities and prices here come
// from Pricing Analysis, which is the one the sheet's own quote page reads.
//
// Re-generated against V3.6 on 2026-09-01: byte-identical to the V3.4 output.
// V3.6's only data change was correcting the 'Tables' ext-battery quantities for
// 3PH-12KVA (2 -> 3) and 3PH-24KVA (4 -> 6) and their ventilation rates — the
// figures this file already carried, because it reads Pricing Analysis.
...
'1PH- 0.5KVA': { system:'1PH- 0.5KVA', build:'No Parallel', duration:'3hr', total:5505.99,
  ...
  ctrlType:'Type A',ctrlDims:'W335 x D750 x H950',ctrlWeight:'67 / 92 kg',extType:'N/A',extDims:'N/A',extWeight:'N/A',extStrings:'N/A',intIncl:'Separate battery kit',intSep:'P-103003010-002 x1',ventBoost:'N/A',ventFloat:'N/A',
  rows:[
    ...
    mkRow('Connection area expansion kit',      'P-103002588',      1,162.02,'',                                       ''),
    ...
    mkRow('External battery cabinet',           '—',                0,0.00,'',                                       'External Battery Cabinet(s)'),
  ]},
'1PH- 1KVA': { system:'1PH- 1KVA', build:'No Parallel', duration:'3hr', total:7457.32,
...
'1PH- 2KVA': { system:'1PH- 2KVA', build:'No Parallel', duration:'3hr', total:8966.43,
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    0,0.00,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103002588',      1,162.02,'',                                       ''),
    mkRow('Internal batteries Item Code',       'N/A',              0,0.00,'',                                       'Internal Batteries'),
...
'1PH- 4KVA': { system:'1PH- 4KVA', build:'No Parallel', duration:'3hr', total:12089.78,
...
'1PH- 5KVA': { system:'1PH- 5KVA', build:'No Parallel', duration:'3hr', total:13480.43,
...
'1PH- 8KVA': { system:'1PH- 8KVA', build:"2x 4 KVA's", duration:'3hr', total:24450.04,
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    1,270.48,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103002588',      2,162.02,'',                                       ''),
    mkRow('Internal batteries Item Code',       'N/A',              0,0.00,'',                                       'Internal Batteries'),
...
'1PH- 10KVA': { system:'1PH- 10KVA', build:"2x 5 KVA's", duration:'3hr', total:27231.34,
  kva:10,capW:9500,phases:'Single',supplyV:230,outputA:41.3,heatKW:0.8,fuseRect:'2x40A',fuseBypass:'2x40A',inCable:'2x 10mm²',outCable:'2x 10mm²',fault:'218A',cRear:'150mm',cFront:'500mm',cTop:'500mm',
...
'1PH- 12KVA': { system:'1PH- 12KVA', build:"3x 4 KVA's", duration:'3hr', total:36810.29,
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    2,270.48,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103002588',      3,162.02,'',                                       ''),
    mkRow('Internal batteries Item Code',       'N/A',              0,0.00,'',                                       'Internal Batteries'),
...
'1PH- 15KVA': { system:'1PH- 15KVA', build:"3x 5 KVA's", duration:'3hr', total:40982.24,
...
'1PH- 16KVA': { system:'1PH- 16KVA', build:"4x 4 KVA's", duration:'3hr', total:49170.55,
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    3,270.48,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103002588',      4,162.02,'',                                       ''),
    mkRow('Internal batteries Item Code',       'N/A',              0,0.00,'',                                       'Internal Batteries'),
...
'1PH- 20KVA': { system:'1PH- 20KVA', build:"4x 5 KVA's", duration:'3hr', total:54733.15,
...
'3PH- 6KVA': { system:'3PH- 6KVA', build:'No Parallel', duration:'3hr', total:14946.71,
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    0,0.00,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103003732',      1,259.46,'',                                       ''),
    mkRow('Internal batteries Item Code',       'Included',         0,0.00,'',                                       'Internal Batteries'),
    mkRow('External battery cabinet',           'P-105000084-002',  1,7974.44,'EBC-B-1x32-CSBHRL12200W-BB-63A-M6',      'External Battery Cabinet(s)','EBC-B','1750H x 761W x 750D','706 / 733 kg'),
  ]},
'3PH- 8KVA': { system:'3PH- 8KVA', build:'No Parallel', duration:'3hr', total:21056.53,
  kva:8,capW:7600,phases:'Three',supplyV:400,outputA:19,heatKW:0.6,fuseRect:'3x25A',fuseBypass:'3x25A',inCable:'(4C)4mm²',outCable:'(4C)4mm²',fault:'54A/ph',cRear:'150mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 10KVA': { system:'3PH- 10KVA', build:'No Parallel', duration:'3hr', total:22921.15,
...
'3PH- 12KVA': { system:'3PH- 12KVA', build:'No Parallel', duration:'3hr', total:31490.63,
  kva:12,capW:11400,phases:'Three',supplyV:400,outputA:28.5,heatKW:1.3,fuseRect:'3x50A',fuseBypass:'3x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'108A/ph',cRear:'250mm',cFront:'500mm',cTop:'650mm',
...
'3PH- 14KVA': { system:'3PH- 14KVA', build:'No Parallel', duration:'3hr', total:36233.02,
...
'3PH- 16KVA': { system:'3PH- 16KVA', build:'No Parallel', duration:'3hr', total:38004.45,
  kva:16,capW:15200,phases:'Three',supplyV:400,outputA:38,heatKW:1.3,fuseRect:'3x50A',fuseBypass:'3x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'108A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 18KVA': { system:'3PH- 18KVA', build:'No Parallel', duration:'3hr', total:39465.06,
...
'3PH- 20KVA': { system:'3PH- 20KVA', build:'No Parallel', duration:'3hr', total:45788.25,
  kva:20,capW:19000,phases:'Three',supplyV:400,outputA:47.5,heatKW:1.3,fuseRect:'3x50A',fuseBypass:'3x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'108A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 24KVA': { system:'3PH- 24KVA', build:"2x12 KVA's", duration:'3hr', total:63251.73,
  kva:24,capW:22800,phases:'Three',supplyV:400,outputA:57,heatKW:2.6,fuseRect:'6x50A',fuseBypass:'6x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'216A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    1,270.48,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103003732',      2,259.46,'',                                       ''),
    mkRow('Internal batteries Item Code',       'N/A',              0,0.00,'',                                       'Internal Batteries'),
...
'3PH- 28KVA': { system:'3PH- 28KVA', build:"2x14 KVA's", duration:'3hr', total:72736.51,
  kva:28,capW:26600,phases:'Three',supplyV:400,outputA:66.5,heatKW:2.6,fuseRect:'6x50A',fuseBypass:'6x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'216A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 30KVA': { system:'3PH- 30KVA', build:"3x 10 KVA's", duration:'3hr', total:69304.39,
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    2,270.48,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103003732',      3,259.46,'',                                       ''),
    mkRow('Internal batteries Item Code',       'Included',         0,0.00,'',                                       'Internal Batteries'),
    mkRow('External battery cabinet',           'P-105000084-002',  6,7974.44,'EBC-B-1x32-CSBHRL12200W-BB-63A-M6',      'External Battery Cabinet(s)','EBC-B','1750H x 761W x 750D','706 / 733 kg'),
  ]},
'3PH- 32KVA': { system:'3PH- 32KVA', build:"2x 16 KVA's", duration:'3hr', total:76279.38,
  kva:32,capW:30400,phases:'Three',supplyV:400,outputA:76,heatKW:2.6,fuseRect:'6x50A',fuseBypass:'6x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'216A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 36KVA': { system:'3PH- 36KVA', build:"2x 18 KVA's", duration:'3hr', total:79200.60,
  kva:36,capW:34200,phases:'Three',supplyV:400,outputA:85.5,heatKW:2.6,fuseRect:'6x50A',fuseBypass:'6x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'216A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 40KVA': { system:'3PH- 40KVA', build:"2x 20 KVA's", duration:'3hr', total:91846.98,
  kva:40,capW:38000,phases:'Three',supplyV:400,outputA:95,heatKW:2.6,fuseRect:'6x50A',fuseBypass:'6x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'216A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 42KVA': { system:'3PH- 42KVA', build:"3x 14 KVA's", duration:'3hr', total:109240.01,
...
'3PH- 48KVA': { system:'3PH- 48KVA', build:"3x 16 KVA's", duration:'3hr', total:114554.30,
  kva:48,capW:45600,phases:'Three',supplyV:400,outputA:114,heatKW:3.9,fuseRect:'9x50A',fuseBypass:'9x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'324A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 54KVA': { system:'3PH- 54KVA', build:"3x 18 KVA's", duration:'3hr', total:118936.14,
...
'3PH- 56KVA': { system:'3PH- 56KVA', build:"4x14 KVA's", duration:'3hr', total:145743.51,
  kva:56,capW:53200,phases:'Three',supplyV:400,outputA:133,heatKW:5.2,fuseRect:'12x50A',fuseBypass:'12x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'432A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
  ...
  rows:[
    ...
    mkRow('External parallel kit',              'P-103000847SP',    3,270.48,'Kit 93PM External Parallel',             'Kit 93PM External Parallel'),
    mkRow('Connection area expansion kit',      'P-103003732',      4,259.46,'',                                       ''),
    mkRow('Internal batteries Item Code',       'N/A',              0,0.00,'',                                       'Internal Batteries'),
...
'3PH- 60KVA': { system:'3PH- 60KVA', build:"3x 20 KVA's", duration:'3hr', total:137905.72,
  kva:60,capW:57000,phases:'Three',supplyV:400,outputA:142.5,heatKW:3.9,fuseRect:'9x50A',fuseBypass:'9x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'324A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 64KVA': { system:'3PH- 64KVA', build:"4x 16 KVA's", duration:'3hr', total:152829.23,
  kva:64,capW:60800,phases:'Three',supplyV:400,outputA:152,heatKW:5.2,fuseRect:'12x50A',fuseBypass:'12x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'432A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 72KVA': { system:'3PH- 72KVA', build:"4x 18 KVA's", duration:'3hr', total:158671.69,
  kva:72,capW:68400,phases:'Three',supplyV:400,outputA:171,heatKW:5.2,fuseRect:'12x50A',fuseBypass:'12x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'432A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
...
'3PH- 80KVA': { system:'3PH- 80KVA', build:"4x 20 KVA's", duration:'3hr', total:183964.45,
  kva:80,capW:76000,phases:'Three',supplyV:400,outputA:190,heatKW:5.2,fuseRect:'12x50A',fuseBypass:'12x50A',inCable:'(4C)10mm²',outCable:'(4C)10mm²',fault:'432A/ph',cRear:'250mm',cFront:'500mm',cTop:'500mm',
